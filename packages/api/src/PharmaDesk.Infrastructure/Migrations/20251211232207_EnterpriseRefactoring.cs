...
{
    /// <inheritdoc />
    public partial class EnterpriseRefactoring : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllImagePaths = table.Column<List<string>>(type: "jsonb", nullable: true),
                    Alternatives = table.Column<List<string>>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasShippingService = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepotClaimerUserId = table.Column<long>(type: "bigint", nullable: true),
                    DepotClaimedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_InventoryItems_InventoryItemId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_WarehouseBarems_WarehouseBaremId",
                        column: x => x.WarehouseBaremId,
                        principalTable: "WarehouseBarems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    OfferId = table.Column<int>(type: "integer", nullable: false),
                    TargetPharmacyId = table.Column<long>(type: "bigint", nullable: false),
                    AddedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferTargets", x => new { x.OfferId, x.TargetPharmacyId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfferTargets_PharmacyProfiles_TargetPharmacyId",
                        column: x => x.TargetPharmacyId,
                        principalTable: "PharmacyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockLocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockLocks_Offers_OfferId",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockLocks_PharmacyProfiles_PharmacyProfileId",
                        column: x => x.PharmacyProfileId,
                        principalTable: "PharmacyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_Active_Stock",
                table: "InventoryItems",
                columns: new[] { "PharmacyProfileId", "Quantity" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_Active_Price",
                table: "Offers",
                columns: new[] { "MedicationId", "Price" },
                filter: "\"Status\" = 0 AND \"IsDeleted\" = false");

            migrationBuilder.CreateIndex(
                name: "IX_Offers_InventoryItemId",
                table: "Offers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_WarehouseBaremId",
                table: "Offers",
                column: "WarehouseBaremId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferTargets_TargetPharmacyId",
                table: "OfferTargets",
                column: "TargetPharmacyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockLocks_OfferId_ExpiresAt",
                table: "StockLocks",
                columns: new[] { "OfferId", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_StockLocks_PharmacyProfileId",
                table: "StockLocks",
                column: "PharmacyProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseBarems_MedicationId",
