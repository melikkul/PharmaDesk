...
export const NotificationIcon = () => (
    <div className="item-icon-wrapper" style={{'--icon-bg': '#E8F6F3', '--icon-color': '#1ABC9C'}}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
    </div>
);

export const MessageIcon = () => (
     <div className="item-icon-wrapper" style={{'--icon-bg': '#EBF5FB', '--icon-color': '#3498DB'}}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
    </div>
);

export const ShipmentIcon = () => (
    <div className="item-icon-wrapper" style={{'--icon-bg': '#FDEBD0', '--icon-color': '#F39C12'}}>
...
export const CartIcon = () => (
    <div className="item-icon-wrapper" style={{'--icon-bg': '#F9E79F', '--icon-color': '#F39C12'}}>
