// src/app/tekliflerim/InventoryTable.tsx
'use client';

import React, { useState, useMemo, useCallback } from 'react';
import Link from 'next/link';
// GÜNCELLENDİ: Tipler ve diğer bileşenler için alias kullanıldı
...
import pageStyles from '@/app/tekliflerim/tekliflerim.module.css'; // tekliflerim özel stilleri
import filterStyles from './InventoryFilter.module.css'; // Yeni filtre stilleri

// İkonlar (Mevcutları ve yenileri)
